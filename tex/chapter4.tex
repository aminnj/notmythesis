...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osmet_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osmet_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osmet_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osmet_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osmet_nbtags_in.pdf}  \\
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osnomet_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osnomet_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osnomet_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osnomet_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_osnomet_nbtags_in.pdf}  \\
\caption{ Data to simulation comparisons. From left to right  and top to bottom,
the $\HT$, $\ptmiss$, $\MTmin$, $\Njets$, $\Nbjets$ distributions are
...
\subsection{SUSY: SS tight-loose dilepton events}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlmet_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlmet_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlmet_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlmet_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlmet_nbtags_in.pdf}  \\
\caption{ Data to simulation comparisons. From left to right  and top to bottom,
the $\HT$, $\ptmiss$, $\MTmin$, $\Njets$, $\Nbjets$ distributions are
shown for the TL CR.}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlnomet_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlnomet_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlnomet_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlnomet_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_tlnomet_nbtags_in.pdf}  \\
\caption{ Data to simulation comparisons. From left to right  and top to bottom,
the $\HT$, $\ptmiss$, $\MTmin$, $\Njets$, $\Nbjets$ distributions are
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_mlonz_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_mlonz_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_mlonz_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_mlonz_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_mlonz_nbtags_in.pdf}  \\
\caption{ Data to simulation comparisons. From left to right  and top to bottom,
the $\HT$, $\ptmiss$, $\MTmin$, $\Njets$, $\Nbjets$ distributions are
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_lowmetlowht_ht_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_lowmetlowht_met_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_lowmetlowht_mtmin_in.pdf}
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_lowmetlowht_njets_in.pdf} 
\includegraphics[width=0.19\linewidth]{figs/ssan/cr/run2_lowmetlowht_nbtags_in.pdf}  \\
\caption{ Data to simulation comparisons. From left to right  and top to bottom,
the $\HT$, $\ptmiss$, $\MTmin$, $\Njets$, $\Nbjets$ distributions are
...
\subsection{\smft: Opposite-sign dilepton events}\label{sec:OSCR}

In this control region, the same requirements on $\HT$, $\ptmiss$
and $\Njets$ as in our inclusive \emph{baseline} selection are applied,
 but we require two opposite sign tight
leptons and we remove the $\PZ/\gamma^*$ veto. This control region
coincides with the application region we use for the data-driven
method to estimate the \emph{Charge flips} background.
...
The overall agreement is very good, but there
are some discrepancies in the \Nbjets and BDT distributions that we will monitor as we include additional
corrections to the MC. 
% The ISR/FSR corrections described in Section~\ref{sec:samples}, corresponding to Figure~\ref{fig:isrweight2},
% is applied to the \ttbar sample here. 
% Note that quantities like the \pt for jet 7,8
% correspond to high (5+) ISR/FSR jet multiplicities in OS \ttbar. These are anyway not directly probed in the signal regions,
% consisting mainly of \ttW and \ttZ for which the matrix element provides more partons.



\begin{figure}[!htb]
\centering
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_ht_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_met_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_njets_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_nbtags_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_type_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_os_eventbdt_in.pdf} 
\caption{ Data to simulation comparisons for 2016+2017+2018. From left top to right bottom
...
\caption{ Data to simulation comparisons for 2016+2017+2018, for the additional variables used by the BDT. From left top to right bottom,
$H_T^b$, Nlooseb, Ntightb, $\Delta \phi(\ell_{1},\ell_2)$, 
...
\subsection{\smft: Same-sign tight+fail dilepton events}\label{sec:TLCR}

In this control region, the same requirements on $\HT$, $\ptmiss$
and $\Njets$ as in our inclusive \emph{baseline} selection are applied
, but we require one tight lepton and
one same-sign lepton failing the tight requirement. The control region is
enriched in events with one fake lepton. It corresponds to the application region for the \emph{fake-rate} method, the data-driven
estimate of backgrounds with fake-leptons. The only difference is that in the
fake-rate application we also allow events where the two leptons fail the tight requirements.
...
There is an overall underestimate, consistent with what was seen 
in 2016. The underestimate is flavor-independent, and does not show large trends in the main kinematics.
Such an underestimate in loose-not-tight leptons, if paired with a data FakeRate equal or larger to the MC one,
 can indicate that the Nonprompt lepton background is underestimated by a pure MC prediction.
 Since this background is predicted from data, that is not an issue with the analysis strategy. 

\begin{figure}[!htb]
\centering
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_ht_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_met_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_njets_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_nbtags_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_type_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_tl_eventbdt_in.pdf} 
\caption{ Data to simulation comparisons for 2016+2017+2018. From left top to right bottom
  the $\HT$, $\ptmiss$, $\Njets$, $\Nbjets$, lepton flavor and raw BDT discriminant distributions are
...
\caption{ Data to simulation comparisons for 2016+2017+2018, for the additional variables used by the BDT. From left top to right bottom,
    $H_{T}^b$, Nlooseb, Ntightb, $\Delta \phi(\ell_{1},\ell_2)$, 
$\Delta \eta(\ell_{1},\ell_{2})$, $p_T(\ell_1)$, $p_T(\ell_2)$, $p_T(\ell_3)$,
    $q_1$, $m(\ell_1,j_1)$, max($m(j)/p_T(j)$) and the \pt for jets 1,6,7, and 8;
...
\subsection{SM tttt: Fake-enriched validation region in data}\label{sec:FECR}

In this control region, the same requirements on $\HT$, $\ptmiss$
and $\Njets$ as in our inclusive \emph{baseline} selection are applied
, except we relax the $\HT$ requirement
and require $\Nbjets=1$.
This region has a significant non-prompt component and allows us to check the
...
The overall data/MC normalization factor in this region is 1.06. If fakes are entirely responsible
for this discrepancy, and given that fakes constitute half of the background, this
represents a 12\% normalization increase of fakes, well within the 30\% normalization
uncertainty taken on this process.


\begin{figure}[!htb]
\centering
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_htnb1_ht_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_htnb1_met_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_htnb1_njets_in.pdf}  
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_htnb1_nbtags_in.pdf} 
\includegraphics[width=0.44\linewidth]{figs/ftan/cr/run2_htnb1_type_in.pdf} 
\caption{ Data to simulation comparisons for 2016+2017+2018. From left top to right bottom
  the $\HT$, $\ptmiss$, $\Njets$, $\Nbjets$, lepton flavor and raw BDT discriminant distributions are
